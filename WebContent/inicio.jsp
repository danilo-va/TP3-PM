              ...
              <div class="box box-primary">
                ...
                <div class="box-body no-padding">
                  <ul class="users-list clearfix">
                    <%
                    int recentUsersCount = 0;
                    ArrayList<User> recentUsers = msgDao.getRecentUsers(loggedUser.getId());
	                	for(User u : recentUsers){
	                		recentUsersCount++;
	                		out.print("<li>");
	                		out.print("<img src=\"img/" + u.getPhotoFile() + "\" alt=\"User Image\">");  
		                    out.print("<a class=\"users-list-name\" href=chat.jsp?userId=" + loggedUser.getId() + "&contactId=" + u.getId() + ">" + u.getName() + "</a>");
		                    out.print("</li>");
	                	}
	                	
	                	for(int i=recentUsersCount; i<8; i++){
	                		out.print("<li>");
	                		out.print("<img src=\"img/default.jpg\" alt=\"User Image\">");  
		                    out.print("<a class=\"users-list-name\" href=\"addContact.jsp\"> Adicionar Contato </a>");
		                    out.print("</li>");
	                	}
                    %>
                  </ul>
