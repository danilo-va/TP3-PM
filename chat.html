    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>Danilo Viana</p>
            <button id ='status' onclick="changeStatus()" style="border: none; background-color: transparent;"><i class="fa fa-circle text-success"></i> Online</button>
        </div>
      </div>
      <div class="btn-group">
                  <button class="fa fa-circle text-success dropdown-toggle" data-toggle="dropdown" style="border: none; background-color: transparent;"> Online</button>
